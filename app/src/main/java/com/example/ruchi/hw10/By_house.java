 ...
 */
public class By_house extends Fragment {
    ...
    final String legisURL="https://helloworld-09.appspot.com/index.php?legisHouse";
    private RequestQueue requestQueue;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        legisHouseView=inflater.inflate(R.layout.legis_house,container,false);
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        try{
                            ...
                            try {
                                ...
                                listview = (ListView)legisHouseView.findViewById(R.id.house_list_view);
