 ...
 */
public class Com_House extends Fragment {
    ...
    final String legisURL="https://helloworld-09.appspot.com/index.php?comHouse";
    private RequestQueue requestQueue;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        comHouseView=inflater.inflate(R.layout.com_state_layout,container,false);
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        try{
                            ...
                            try {
                                ...
                                listview = (ListView)comHouseView.findViewById(R.id.com_list_view);
