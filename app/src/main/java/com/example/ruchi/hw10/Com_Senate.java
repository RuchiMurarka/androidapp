 ...
 */
public class Com_Senate extends Fragment {
    ...
    final String legisURL="https://helloworld-09.appspot.com/index.php?comSenate";
    private RequestQueue requestQueue;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        comSenateView=inflater.inflate(R.layout.com_state_layout,container,false);
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        try{
                            ...
                            try {
                                ...
                                listview = (ListView)comSenateView.findViewById(R.id.com_list_view);
