...
public class NewBills extends Fragment {
    ...
    final String legisURL="https://helloworld-09.appspot.com/index.php?newbills";
    private RequestQueue requestQueue;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        newBillsView=inflater.inflate(R.layout.bill_active_layout,container,false);
                    ...
                    public void onResponse(JSONArray jsonArray) {
                        try{
                            ...
                            try {
                                ...
                                listview = (ListView)newBillsView.findViewById(R.id.bill_list_view);
